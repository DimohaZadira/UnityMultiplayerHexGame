...
public class GayManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject abobus_go = SpawnAbobus<Sohad>(Resources.Load("Abobi/KnightPrefab"), new Vector2(5, 9), Team.blue);
        ...
        abobus_go = SpawnAbobus<Sohad>(Resources.Load("Abobi/KnightPrefab"), new Vector2(5, 10), Team.blue);
        abobus_go.GetComponentInChildren<Renderer>().material.color = Color.blue;
        abobi[Team.blue].Add(abobus_go);
        RefreshHexCellState(abobus_go.GetComponent<Abobus>().hex_coordinates);
        
        abobus_go = SpawnAbobus<Sohad>(Resources.Load("Abobi/KnightPrefab"), new Vector2(4, 9), Team.yellow);
